...
while ((bandierinePiazzate.length < bandierineMax) && (boom === false)) {
    ...
    if (bandierinaDaPiazzare>=1 && bandierinaDaPiazzare<=dimensioneCampo) {
        ...
        alert('Il numero che hai inserito non rientra nei limiti consentiti o non hai inserito un numero');
    }
}
...
function sceltaDifficolta() {
    ...
    switch (scelta) {
        ...
        default:
            var dimCampo = 100;
            alert('Il numero da te inserito non è tra quelli indicati. Di default verrà impostata la difficoltà minima');
    }
    return dimCampo;
}
